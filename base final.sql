...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_detalle_insert`(in cedula int ,in categoria int,in estado int ,in cantidad int,in fecha date,in fechadon date)
BEGIN
declare sig int;
	   ...
	   VALUES (sig,cedula,categoria,estado,cantidad,fecha,fechadon);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2022-11-27 23:56:50
