...
INSTITUTO SUPERIOR TECNOLÓGICO 17 DE JULIO"),1,'L',0);
$x=$pdf->getx();
$y=$pdf->gety();
...
$pdf->SETxy($x+85,$y);	
if (utf8_decode($detalle[0])=='PERMISO PARA ESTUDIOS REGULARES' and $ban==0){	
    $pdf->MultiCell(15,6,"X",1,'C',0);
	$ban=1;
}
else
...
$pdf->SETxy($x+85,$y);
if (utf8_decode($detalle[0])=='PERMISO POR ASUNTOS OFICIALES	' and $ban==0){	
    $pdf->MultiCell(15,6,"X",1,'C',0);
	$ban=1;
}
else
