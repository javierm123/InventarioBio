...
$pdf->SetY($i+34);
$pdf->SetX(23);
$pdf->MultiCell(42,9,'THC: '.$nlunes.' THD: '.$olunes.' T: '.intval($nlunes+$olunes),1,'C','L',1);
$pdf->SetY($sig);
$sig = $pdf->GetY();
$pdf->GetY();
$pdf->SetY($i+34);
$pdf->SetX(65);
$pdf->MultiCell(42,9,'THC: '.$nmartes.' THD: '.$omartes.' T: '.intval($nmartes+$omartes),1,'C','L',1);
$pdf->SetY($sig);
$sig = $pdf->GetY();
$pdf->GetY();
$pdf->SetY($i+34);
$pdf->SetX(107);
$pdf->MultiCell(42,9,'THC: '.$nmiercoles.' THD: '.$omiercoles.' T: '.intval($nmiercoles+$omiercoles),1,'C','L',1);
$pdf->SetY($sig);
$sig = $pdf->GetY();
$pdf->GetY();
$pdf->SetY($i+34);
$pdf->SetX(149);
$pdf->MultiCell(42,9,'THC: '.$njueves.' THD: '.$ojueves.' T: '.intval($njueves+$ojueves),1,'C','L',1);
$pdf->SetY($sig);
$sig = $pdf->GetY();
$pdf->GetY();
$pdf->SetY($i+34);
$pdf->SetX(191);
$pdf->MultiCell(42,9,'THC: '.$nviernes.' THD: '.$oviernes.' T: '.intval($nviernes+$oviernes),1,'C','L',1);
$pdf->SetY($sig);
$sig = $pdf->GetY();
$pdf->GetY();
$pdf->SetY($i+34);
$pdf->SetX(233);
$pdf->MultiCell(42,9,'THC: '.$nsabado.' THD: '.$osabado.' T: '.intval($nsabado+$osabado),1,'C','L',1);
